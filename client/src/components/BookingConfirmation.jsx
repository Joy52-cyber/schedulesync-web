    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="w-24 h-24 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl animate-bounce">
        ...
        {bookingData.meet_link && (
          <div className="bg-gradient-to-br from-purple-500 to-blue-500 rounded-3xl shadow-2xl p-8 mb-6 text-white">
          ...
          {bookingData.event_type && (
            <div className="mt-6 pt-6 border-t-2 border-gray-100">
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <span className="text-sm">Meeting Type: <strong className="text-gray-900">{bookingData.event_type}</strong></span>
              </div>
            </div>
          )}
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-gray-900">Add to Your Calendar</h3>
            </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-gray-900">
                    {copied ? 'Copied to Clipboard!' : 'Copy Meeting Details'}
                  </span>
                </div>
              </button>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  A calendar invite has been sent to <span className="font-semibold">{bookingData.attendee_email}</span>
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900">Save to Your Calendar</p>
                <p className="text-sm text-gray-600">
                  Use the buttons above to add this meeting to Google or Outlook
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900">Join at the Scheduled Time</p>
                <p className="text-sm text-gray-600">
                  {bookingData.meet_link 
                    ? 'Use the Google Meet link above or from your calendar invite'
                    : 'Use the meeting link from your calendar invite to join'}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="text-center text-gray-500 text-sm">
          <p>You can safely close this page. All details have been sent to your email.</p>
          <p className="mt-2">
