                  ...
                  return (
                    <div className="text-center py-8">
                      ...
                      <p className="text-sm text-gray-400 mt-1">
                        {bookingFilter === 'upcoming' ? 'Share your booking page to get started!' : 'Your completed meetings will appear here'}
                      </p>
                    </div>
                  );
                }
                    ...
                    {filteredBookings.slice(0, 5).map((booking) => (
                      ...
                      >
                        <div className="flex items-center gap-4 flex-1">
                          ...
                          <div className="flex-1">
                            <h3 className="font-bold text-gray-900">{booking.title || 'Untitled Meeting'}</h3>
                            <p className="text-sm text-gray-600">{booking.attendee_name || booking.attendee_email}</p>
                          </div>
                        </div>
