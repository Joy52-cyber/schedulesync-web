  ...
  const loadDashboardData = async () => {
    try {
      ...
      setStats({
        ...
        weeklyBookings: data.stats?.weeklyBookings || 0,
      ...
      if (data.recentBookings && data.recentBookings.length > 0) {
        ...
        if (upcoming) {
          setNextMeeting({
            ...
            time: Math.ceil((new Date(upcoming.start_time) - new Date()) / (1000 * 60)),
    ...
    try {
      ...
      for (let i = 0; i < 7; i++) {
        ...
        week.push({
          ...
          count: 0, // Will be populated from bookings
      ...
      <main className="w-full">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="space-y-6">
                          ...
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <div className="flex items-center gap-2">
                              <button 
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  navigator.clipboard.writeText(`${window.location.origin}/${user.username}/${event.slug}`);
            ...
            {/* Upgrade Card - Keep yours but only show if not showing event types */}
