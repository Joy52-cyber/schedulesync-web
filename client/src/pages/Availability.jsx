...
export default function Availability() {
  ...
  const copyToWeekdays = (sourceDay) => {
    const src = availability.workingHours[sourceDay];
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1 max-w-xl">
              Decide when people can book time with you. These settings power
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 sm:p-6 mt-6">
          ...
          <div className="divide-y divide-gray-100 rounded-xl border border-gray-100 overflow-hidden bg-gray-50/40">
            {WEEKDAYS.map((day) => {
              ...
              return (
                <div
                  key={day.key}
                  className={`flex flex-col md:grid md:grid-cols-[170px,1fr] items-stretch px-4 py-3 ${
                    isWeekend ? 'bg-gray-50' : 'bg-white hover:bg-blue-50/40'
                  }`}
                >
                  {/* Day + toggle */}
          ...
          <div className="mt-6 pt-4 border-t border-gray-100">
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm">
              <span className="text-gray-700">Buffer before/after meetings:</span>
              ...
              <p className="text-xs text-gray-400">
                We'll automatically protect this spacing between bookings.
              </p>
            </div>
          </div>
